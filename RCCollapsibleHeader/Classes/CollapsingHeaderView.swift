...
@IBDesignable
open class CollapsingHeaderView: UIView {
...
//    }
    ...
    @IBInspectable
    open var minHeight: CGFloat = 81
    
    @IBInspectable
    open var maxHeight: CGFloat = 44 {
        didSet {
            setNeedsLayout()
    ...
    public var delegate: CollapsingHeaderViewDelegate?
...
public extension CollapsingHeaderView {
...
private extension CollapsingHeaderView {
